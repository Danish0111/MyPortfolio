...
const Skills = () => {
  ...
  return (
      <div className="skills_container h-full mb-24 lg:mb-40 max-w-6xl flex flex-col justify-center items-center mx-auto px-2 md:px-10 lg:px-24 max-md:mt-20">
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-12 gap-x-10 md:gap-x-28 min-lg:gap-x-32 py-2 place-items-center'>
          {loading
            ...
            : skills.map(skill => (
              <motion.div initial={{scale: 0.5, y: -100, opacity: 0}} whileHover={{scale: 1.14}} whileInView={{scale: 1, opacity: 1, y: 0}} transition={{duration: 1}} key={skill.id} className="skillCard w-32 md:w-36  flex flex-col justify-center items-center gap-2 bg-[#121213ee] rounded-xl shadow-xl p-4">
