...
const Contact = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await fetch("https://portfolio-backend-lilac-three.vercel.app/", {
                method: "POST",
                headers: {
    ...
    return (
        <>
            ...
            <div className='flex flex-col justify-center items-center max-w-6xl mx-auto mb-8 lg:my-10 px-2 md:px-10 lg:px-24 max-md:mt-20'>
